...
- npm package: `@drapt-lab/mcp-houjin-bangou`
...
1. Open npm account settings for `drapt-lab`.
2. Confirm the `@drapt-lab` scope exists and the account can publish public scoped packages.
3. In npm Trusted Publishing, create a package connection:
  - Package: `@drapt-lab/mcp-houjin-bangou`
...
npm error 404 Not Found - PUT https://registry.npmjs.org/@drapt-lab%2fmcp-houjin-bangou
npm error 404 '@drapt-lab/mcp-houjin-bangou@0.2.0' is not in this registry.
```
...
name: @drapt-lab/mcp-houjin-bangou
version: 0.2.0
package size: 250.6 kB
total files: 151
```
